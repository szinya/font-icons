...
Gem::Specification.new do |gemspec|
  ...
  gemspec.description = "Font Icons includes base fonts called EntypoRegular and Iconic, and easy to remember variable names. Font Icons produces a number of mixins that will allow for the easy generation of font-face declarations and icons."
  ...
  gemspec.add_dependency 'compass', '>= 0.12'
